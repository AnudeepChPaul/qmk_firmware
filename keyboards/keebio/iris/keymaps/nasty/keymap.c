...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
      ...
      LSFT_T(KC_TAB), KC_1, KC_2, KC_3, KC_4, KC_5,                                             KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLS,

      LCTL_T(KC_ESC), KC_6, KC_7, KC_8, KC_9, KC_0,                                             KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,

      LSFT_T(KC_CAPS), HYPR_T(KC_Z), MEH_T(KC_X), LCA_T(KC_COLN), KC_LPRN, KC_LBRC, KC_ASTR, KC_BSPC, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, LSFT_T(KC_MINS),

                                              KC_LGUI, KC_AMPR, KC_UNDS,            KC_SPC, MO(1), KC_LALT
  ),

  [_RAISE] = LAYOUT(
      TG(3), KC_1, KC_2, KC_3, KC_4, KC_5,                                                 KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,

      KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T,                                                 KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,

      LCTL_T(KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G,                                         KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_SCLN, KC_ESC,

      KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_BSPC,                 KC_DOT, KC_RBRC, KC_RPRN, KC_COMM, LCA_T(KC_DOT), MEH_T(KC_SLSH), HYPR_T(KC_MINS),

                          KC_LGUI, MO(2), KC_SCLN,                           KC_MINS, KC_QUOT, KC_SLSH
  ),
